...
function onComplete() {
    if (script.callApiFunc && script.scriptWithApi && script.onCompleteFunction && script.scriptWithApi.api[script.onCompleteFunction]) {
        script.scriptWithApi.api[script.onCompleteFunction]();
    }
